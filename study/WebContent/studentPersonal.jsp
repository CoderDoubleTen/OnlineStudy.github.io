	...
	<div class="container px-2 py-1"
		...
		<div class="card-deck" style="margin: 0; filter: opacity(75%);">
			<div class="row" style="margin: 0 auto; width: 100%">
				...
				<div class="col-md-4">
					<form action="alertStudentHeadImg" method="post"
						enctype="multipart/form-data">
						<img id="img" alt="头像"
							src="<s:property value='student.studentImg'/>" width="300px"
							height="300px"> <input type="file" id="studentImg"
							name="myFile"><br> <input type="hidden"
							id="studentImgName" name="myFileName"> <input
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control-plaintext"
									name="student.studentAccount" id="studentAccount"
									value="<s:property value="student.studentAccount"/>" disabled>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control-plaintext"
									name="student.studentName" id="studentName"
									value="<s:property value="student.studentName"/>" disabled>
							</div>
						</div>
						<div class="form-group row">
							<label for="studentSex" class="col-sm-2 col-form-label">性别</label>
							<div class="col-sm-10 pt-2">
								<s:if test="student.studentSex==1">
									<input type="radio" name="student.studentSex" value="1" checked
										disabled>男
    <input type="radio" name="student.studentSex" value="0" disabled>女
    
    </s:if>
								<s:elseif test="student.studentSex==0">
									<input type="radio" name="student.studentSex" value="1"
										disabled>男
    <input type="radio" name="student.studentSex" value="0" checked
										disabled>女
    </s:elseif>
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control-plaintext"
									name="student.studentTel" id="studentTel"
									value="<s:property value="student.studentTel"/>">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="password" class="form-control-plaintext"
									name="student.studentPassword.password" id="studentPassword"
									value="<s:property value="student.studentPassword.password"/>">
							</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-9">
												<input id="newPassword" type="password"
													name="student.studentPassword.password" placeholder="新密码">
											</div>
										</div>
									</div>
		...
		<a href="queryStuIndex.action" class="btn btn-primary mt-2 ml-3">返回</a>
	</div>
</body>
</html>