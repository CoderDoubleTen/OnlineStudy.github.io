	...
	<div class="container">
		...
		<div class="row mx-0 my-1 py-3"
			...
			<div class="col-md-10 text-dark mt-1" style="margin: 0 auto">
				...
				<%-- <h5>课程介绍:${sessionScope.video.course.courseIntroduction}</h5> --%>
			</div>
		</div>
				...
				<ul class="media-list">
					<form action="addCommentByStu" method="post">
						<li><input type="hidden" name="comment.comment_index"
							...
							value="${sessionScope.userinfo.u_id}"> <!-- 视频所属用户的id -->
							...
							<div class="media-body">
								...
								<%-- <s:iterator value="commentForPages2">
									<div class="media">
										...
										<div class="media-body">
											<h4 class="media-heading">
												<s:property value="comment2.comment_title" />
											</h4>
											<p>
												<s:property value="comment2.comment_content" />
											...
											<s:iterator value="comments3">
												<div class="media">
													...
													<div class="media-body">
														<h4 class="media-heading">
															<s:property value="comment_title" />
														</h4>
														<P>
