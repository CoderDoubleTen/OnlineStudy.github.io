...
<body>
	...
	<div class="container">
		...
		<div class="container mt-1"
			...
			<div class="row">
				<div class="col-md-3">
					<h2 class="mt-1" style="color: #fff">我的视频</h2>
				</div>
				<div class="col-md-9">
	<div class="p-2 my-2 my-lg-0 float-right">
					<!-- 	<input class="form-control mr-sm-2" type="search"
							placeholder="课程名称" aria-label="Search" name="course.courseName"> -->
						<button class="btn btn-outline-white my-2 my-sm-0"  type="button"><a href="initUploadVideo">上传视频</a></button>
					</div>
	</div>
				...
				<div class="row" style="margin: 0 auto; width: 100%">
					<s:iterator value="videos">
						<div class="col-md-2" style="filter: opacity(85%);">
							<a
								href="queryVideoDetailByTea.action?id=<s:property value='v_id' />">
								<div class="card" style="border: none; margin: 0">			
									...
									<s:property value="courseName" />
										...
										<p class="card-text"
											...
											<s:if test="videoStatu==1">可用</s:if>
											<s:if test="videoStatu==2">禁用</s:if>
											<%-- <s:property
													value="videoStatu" /> --%>
													</small>
											<small class="text-muted float-right">
											<a href="deleteVideoByTea.action?id=<s:property value='v_id'/>">删除</a>
											</small>
										</p>
									</div>
								</div>
