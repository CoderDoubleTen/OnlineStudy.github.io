...
$(function(){
	...
	if(${sessionScope.videoSize}!=0){
		$("#zanwu").hide();
	}else{
		$("#zanwu").show();
	}
	if(${sessionScope.courseSelectionsSize}!=0){
		$("#weijiaru").hide();
		$("#yijiaru").show();
	}else{
		$("#yijiaru").hide();
	...
	<div class="container">
		...
		<div class="row mx-0 my-1 py-3"
			...
			<div class="col-md-5 text-dark" style="padding: 2em 1em 0 1em">
				...
				<a href="addCourse.action?id=${sessionScope.course.c_id}" id="weijiaru" class="btn btn-primary mt-2 ml-3 addCourse">加入学习</a>
			
			<a href="javascript:void(0)" id="yijiaru" class="btn btn-primary mt-2 ml-3 addCourse">已加入学习</a>
